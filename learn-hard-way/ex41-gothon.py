...
ROOMS = {
    ...
    'laser_weapon_armoury': laser_weapon_armoury,
    'the_bridge': the_bridge,
    'escape_pod': escape_pod
}

def runner(map, start):
    next = start # start contains the name of the first room
    
    while True:
        room = map[next] # this is ROOMS['central_corridor'] so returns the variable central_corridor
        print("\n------")
        next = room() # room now contains the variable e.g. central_corridor so this calls the 
		# function central_corridor()
